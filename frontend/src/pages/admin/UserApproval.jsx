  ...
  return (
    <div className="container mx-auto px-4 pt-6">
      <div className="space-y-6">
          ...
          {migrationRequired ? (
            <div className="bg-yellow-900 border border-yellow-700 rounded-lg p-8 text-center">
              <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-yellow-800 mb-4">
              ...
              <h3 className="text-lg font-medium text-yellow-100 mb-2">Database Migration Required</h3>
              <p className="text-yellow-200 mb-4">
                The user approval system requires database changes. Please run the SQL migration script in Supabase.
              </p>
              <div className="bg-midnight-800 rounded p-4 text-left">
                <p className="text-sm font-medium text-midnight-200 mb-2">Steps to fix:</p>
                <ol className="text-sm text-midnight-300 space-y-1">
              ...
              <button
                ...
                className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-midnight-50 bg-midnight-600 hover:bg-midnight-500"
              >
                Retry After Migration
              </button>
            </div>
          ) : pendingUsers.length === 0 ? (
            <div className="bg-midnight-900 border border-midnight-700 shadow rounded-lg p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-midnight-100 mb-2">All Caught Up!</h3>
              <p className="text-midnight-400">No users are currently pending approval.</p>
            </div>
          ) : (
            <div className="bg-midnight-900 border border-midnight-700 shadow overflow-hidden sm:rounded-md">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4 flex-1">
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-800 text-yellow-200">
                                Pending
                              </span>
                            </div>
                            <p className="text-sm text-midnight-400">{user.email}</p>
                            {user.phone && (
                              <p className="text-sm text-midnight-400">📞 {user.phone}</p>
                            )}
                            {user.address && (
                              <p className="text-sm text-midnight-400">📍 {user.address}</p>
                            )}
